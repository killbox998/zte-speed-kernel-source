...
/*
  * fix a bug eeprom power down
  * 
  * by ZTE_YCM_20141031 yi.changming 000096
  */
// --->
		for (c = 0; c < size; c++) {
			if (power_info->power_down_setting[c].seq_type == SENSOR_GPIO) {
				power_info->power_down_setting[c].config_val = GPIO_OUT_LOW;
			}
		}
// <---000096
	}
...
/*
  * Added  camera sensor gpio IOVDD control  
  * 
  * by ZTE_YCM_20140718 yi.changming 000019
  */
// --->
