...
#define AKM_HAS_RESET			0 //disable reset ZTE_GPS_LPZ_20140723
...
AKECS_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case ECS_IOCTL_RESET:
		//+++Add for disable reset ZTE_SNS_LPZ_20140723
		#if AKM_HAS_RESET
...
static int akm_compass_suspend(struct device *dev)
{
	...
	dev_dbg(dev, "Enter akm_compass_suspend\n");
	...
	//+++ Add for disabling pinctrl ZTE_SNS_LPZ_20140806
    #if AKM_HAS_RESET
...
//+++Add for disable reset ZTE_SNS_LPZ_20140806
#if AKM_HAS_RESET
