...
static int msm_rpm_flush_requests(bool print)
{
	...
	for (t = rb_first(&tr_root); t; t = rb_next(t)) {
		...
		//zte_pm shuangdan fix the patch 4b967fbe5043e008ec54f4e7d7e01171befecb1d begin
	...
	//zte_pm shuangdan fix the patch 4b967fbe5043e008ec54f4e7d7e01171befecb1d end	
	}
	return 0;
}
